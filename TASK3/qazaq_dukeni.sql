...
-- ============================================================
DROP SCHEMA IF EXISTS qazaq_dukeni;
CREATE SCHEMA qazaq_dukeni
    DEFAULT CHARACTER SET utf8mb4       -- supports Cyrillic & Latin Kazakh characters
...
) COMMENT = 'Product categories for Qazaq Dukeni';
...
CREATE TABLE suppliers (
    ...
    phone_number    VARCHAR(15)     NOT NULL,               -- VARCHAR(15) fits international formats incl. '+'
...
CREATE TABLE customers (
    ...
    city            VARCHAR(100)    NOT NULL DEFAULT 'Almaty', -- Kazakh city default
...
CREATE TABLE payments (
    ...
    payment_type    SET('Card', 'Cash', 'Online', 'QR')  NOT NULL,
...
--   3NF: no transitive deps — category_name not stored in products; city not duplicated
...
--   (3) specific value set (enum)   → order status, ticket status, category status
